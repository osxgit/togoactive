    ...
    <div class="w-full flex flex-col sm:flex-row flex-grow overflow-hidden bg-light-gray-bg">
        ...
        <main role="main" class="w-full h-full flex-grow p-3 overflow-auto">
            <div class="float-left w-full max-w-screen-xl">
                ...
                @endif
                <form method="POST" id="create-event-success-f_010" name="create-event-success-f_010" action="{{route('admin.events.success.store',array($id))}}" class="w-full float-left" autocomplete="false" enctype="multipart/form-data">
                    @csrf
                    ...
                    <x-forms.section class="mt-8 rounded-xl">
                        ...
                        <x-slot name="section_content">
                            <div class="float-left w-full mt-4">
                                <x-forms.textarea id="no_purchase_made" name="no_purchase_made" placeholder="" class="h-32 no_purchase_made ">
                    ...
                    <x-forms.section class="mt-8 rounded-xl">
                        ...
                        <x-slot name="section_content">
                            ...
                            <x-forms.toggle id="enable_referral" name="enable_referral" value="">
                            ...
                            <div class=" py-2  float-left">
                            <x-forms.toggle id="enable_coupon" name="enable_coupon" value="">
...
var tagify = new Tagify(input)
        ...
        tinymce.init({
            selector: 'textarea#no_purchase_made',
