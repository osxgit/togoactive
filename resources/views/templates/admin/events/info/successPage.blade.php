                ...
                <form method="POST" id="create-event-success-page-f_010" name="create-event-success-page-f_010"
                    ...
                    <x-forms.section class="mt-8 rounded-xl">
                        ...
                        <x-slot name="section_content">
                            ...
                            <div class="float-left w-full flex  justify-center items-end @if (($eventsuccess->active_custom_message ?? 0)==0)
                                hidden
            ...
            */
            $("#send_test_email").click(function(e){
                ...
                if(subject!='' && email_body!=''){
                    ...
                    toastr.error('Please fill email subject and body to send test email');
                }
            })
        });
        formchanged = 0;
