<div class="float-left w-full">
    ...
    <div class="float-left w-full bg-white flex items-center rounded-sm border border-ultralightgray p-1 mt-2">
        <input   type="number"  min="1"  {{$attributes->merge(['class' => 'float-left w-full border-0 bg-white h-8 font-poppins text-sm text-placeholder placeholder-gray-200 px-2'])}}>
